...
function ShapePlayground() {
  ...
  return (
    <main style={{ maxWidth: 960, margin: '0 auto', padding: '48px 24px' }}>
      ...
      <svg viewBox="0 0 1 1" width={240} height={240} style={{ marginTop: 32, background: 'var(--md-sys-color-surface-container)' }}>
        <path d={path} fill="var(--md-sys-color-primary)" />
      </svg>

      <section style={{ marginTop: 48 }}>
        <h2>Shape library</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(72px, 1fr))', gap: 12, marginTop: 16 }}>

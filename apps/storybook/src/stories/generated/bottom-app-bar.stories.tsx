...
const examples = getExamplesForSlug("bottom-app-bar");

const meta = {
  title: 'Navigation/Bottom App Bar',
  tags: ["autodocs","parity-tier-C","parity-ref-tokens-only"],
  parameters: {
    docs: {
      description: {
        component: "Bottom app bar with action slots and attached FAB",
      },
    },
  },
} satisfies Meta;
...
export const Compliance: Story = {
  ...
  render: () => (
    <section className="m3-story-compliance">
      ...
      <p>Bottom app bar with action slots and attached FAB</p>
      <dl>

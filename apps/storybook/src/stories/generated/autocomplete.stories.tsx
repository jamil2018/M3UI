...
const examples = getExamplesForSlug("autocomplete");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Autocomplete and combobox with M3 text field styling",
      },
    },
  },
} satisfies Meta;
...
export const Compliance: Story = {
  ...
  render: () => (
    <section className="m3-story-compliance">
      ...
      <h2>Autocomplete</h2>
      <p>Autocomplete and combobox with M3 text field styling</p>
      <dl>

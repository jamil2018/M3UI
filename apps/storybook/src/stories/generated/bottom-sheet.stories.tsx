...
const examples = getExamplesForSlug("bottom-sheet");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Modal bottom sheet with snap points and drag handle",
      },
    },
  },
} satisfies Meta;
...
export const Compliance: Story = {
  ...
  render: () => (
    <section className="m3-story-compliance">
      ...
      <h2>Bottom Sheet</h2>
      <p>Modal bottom sheet with snap points and drag handle</p>
      <dl>

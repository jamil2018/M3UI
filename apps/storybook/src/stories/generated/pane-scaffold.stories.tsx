...
const examples = getExamplesForSlug("pane-scaffold");

const meta = {
  title: 'Layout/Pane Scaffold',
  tags: ["autodocs","parity-tier-C","parity-ref-tokens-only"],
  parameters: {
    docs: {
      description: {
        component: "List-detail and supporting-pane adaptive layouts",
      },
    },
  },
} satisfies Meta;
...
export const Compliance: Story = {
  ...
  render: () => (
    <section className="m3-story-compliance">
      ...
      <h2>Pane Scaffold</h2>
      <p>List-detail and supporting-pane adaptive layouts</p>
      <dl>

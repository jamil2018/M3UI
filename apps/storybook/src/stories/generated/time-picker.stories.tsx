...
const examples = getExamplesForSlug("time-picker");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Dial and input time pickers with 12h/24h support",
      },
    },
  },
} satisfies Meta;
...
export const Compliance: Story = {
  ...
  render: () => (
    <section className="m3-story-compliance">
      ...
      <h2>Time Picker</h2>
      <p>Dial and input time pickers with 12h/24h support</p>
      <dl>

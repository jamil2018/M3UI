...
const examples = getExamplesForSlug("meter");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Meter styled consistently with progress indicators",
      },
    },
  },
} satisfies Meta;
...
export const Compliance: Story = {
  ...
  render: () => (
    <section className="m3-story-compliance">
      ...
      <h2>Meter</h2>
      <p>Meter styled consistently with progress indicators</p>
      <dl>
